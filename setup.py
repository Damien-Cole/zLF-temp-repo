...
setup(name='zCluster',
      ...
      package_data={'zCluster': ['data/*', 'SED/CWW/*', 'SED/BR07/*', 'SED/EAZY_v1.0/*', 
                                 'passbands/*']},
      scripts=['bin/zCluster', 'bin/zField', 'bin/zClusterBCG', 'bin/zLF','bin/LFplot','bin/Richness','bin/zLFTest','bin/zLFMass','bin/SchechterfitsPLOT','bin/SFMass','bin/Schechterfits','bin/SchechterfitsTEST','bin/MstarEvo','bin/Alphaevo','bin/MstarvsAlpha','bin/SF-debug','bin/SchechterMulti','bin/SchechterBFfits','bin/Schechter-MassLF','bin/SchechterMCfits','bin/SchechterBFfits-debug',
               'bin/SchechterBFfits-multi','bin/Schechterfitsfmin','bin/zLFPlots','bin/zLFMassBin','bin/zLF-debug','bin/zClusterComparisonPlot'],
